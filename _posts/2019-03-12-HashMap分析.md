...
![img](https://github.com/huairho/huairho.github.io/tree/master/img/hashmap/map-detail.png)

## 数据结构区别

**JDK1.7**的数据结构是**数组+链表**，也称之为**散列链表**。基于一个数组以及多个链表实现的。Hash值冲突时，将对节点以链表的形式存储。数据结构如下图：

![1553592063028](https://github.com/huairho/huairho.github.io/tree/master/img/hashmap/1553592063028.png)
...
![1553595483068](https://github.com/huairho/huairho.github.io/tree/master/img/hashmap/1553595483068.png)
...
![JDK1.7-hashMap.put](https://github.com/huairho/huairho.github.io/tree/master/img/hashmap/jdk1.7-hashMap.put()-flow.png)

**举个栗子:**

![jdk1.7-hashMap.put-example](https://github.com/huairho/huairho.github.io/tree/master/img/hashmap/jdk1.7-hashMap.put-example.png)
...
![jdk1.8-HashMap.put()-flow](https://github.com/huairho/huairho.github.io/tree/master/img/hashmap/jdk1.8-HashMap.put()-flow.png)



**举个栗子**

![jdk1.8-hashMap.put-example](https://github.com/huairho/huairho.github.io/tree/master/img/hashmap/jdk1.8-hashMap.put-example.png)
...
![RBTree](https://github.com/huairho/huairho.github.io/tree/master/img/hashmap/RBTree.png)